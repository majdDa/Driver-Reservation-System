        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <form class="needs-validation text-center" novalidate>
                    <?php
                        $row = get_all("new_reqs", "`is_approve`=0 ORDER BY `id` DESC LIMIT 25");
                        if (sizeof($row) == 0) {
                        ?>
                    <table class="table table-sm table-responsive-sm table-striped">
                        <thead align="center" style="background:#581845; color: white;">
                            <tr>
                                <th scope="col" style="word-wrap: break-word;" class="text-center">#</th>
                                <th scope="col" style="word-wrap: break-word;" class="text-center">Requester Name
                                </th>
                                <th scope="col" style="word-wrap: break-word;" class="text-center">Requester Num
                                </th>
                                ...
                                <th scope="col" style="word-wrap: break-word;" class="text-center">Approve</th>
                                <th scope="col" style="word-wrap: break-word;" class="text-center">Reject</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center" style="word-wrap: break-word;"
                                    onclick="_Approve(<?php echo $row['id']; ?>)">
                                    <button type="button" class="btn btn-outline-success"
                                        id="_Approve-<?php echo $row['id']; ?>" disabled>Approve</button>
                                </td>
                                <td class="text-center" style="word-wrap: break-word;"
                                    onclick="_Reject(<?php echo $row['id']; ?>)">
                                    <button type="button" class="btn btn-outline-danger"
                                        id="_Reject-<?php echo $row['id']; ?>" disabled>Reject</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-sm table-responsive-sm table-bordered table-hover ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="word-wrap: break-word;">
                                    <button type="button" class="btn btn-outline-success"
                                        id="Approve-<?php echo $row['id']; ?>"
                                        onclick="_Approve(<?php echo $row['id']; ?>)"><i class="fa fa-thumbs-o-up"
                                            aria-hidden="true"></i></button>
                                </td>
                                <td class="text-center" style="word-wrap: break-word;">
                                    <button type="button" class="btn btn-outline-danger"
                                        id="Reject-<?php echo $row['id']; ?>"
                                        onclick="_Reject(<?php echo $row['id']; ?>)"><i class="fa fa-thumbs-o-down"
                                            aria-hidden="true"></i></button>
                                </td>
                            </tr>
                        </tbody>
...
<!--===============================================================================================-->
<script type="text/javascript" src="js/_Approval.js"></script>
